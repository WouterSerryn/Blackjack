                ...
                <div id="userBlockContainer">
                    ...
                    <div class="userBlockWrapper">
                        <div onclick="swapSelected(<% out.print(i + "," + "'" + user.getNickname() + "'"); %>)" class="userBlock" id="<% out.print(i); %>">
                            ...
                            <a href="EditIconServlet?nickname=<% out.print(user.getNickname()); %>&iconname=<% out.print(user.getIcon().getIconName()); %>" title="Icoon wijzigen" class="editIcon"><img class="editIconImage" src="images/gear.png" /></a>
                    </div>
                    <%
                            }
                            else
                    ...
                    <div class="userBlockWrapper">
                        <div onclick="noCoins();" class="userBlock" id="<% out.print(i); %>">
                            ...
                            <a href="ModifyIconServlet?nickname=<% out.print(user.getNickname()); %>&iconname=<% out.print(user.getIcon().getIconName()); %>&<% out.print(user.getBalance()); %>" title="Icoon wijzigen" class="editIcon"><img class="editIconImage" src="images/gear.png" /></a>
                    </div>
                    <%
                            }
